    ...
    <div class="pegawai-header">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?= esc($divisi) ?></li>
            </ol>
        </nav>
        <h1>Divisi <?= esc($divisi) ?></h1>
    </div>
    ...
    <div class="divisi-tabs">
        <ul class="nav nav-pills">
            ...
            <li class="nav-item mr-2">
                <a class="nav-link <?= $d === $divisi ? 'active' : '' ?>" 
                   href="<?= base_url('pegawai/divisi/' . strtolower($d)) ?>">
                    <?= $d ?>
                </a>
            </li>
            <?php endforeach; ?>
        ...
        <?php if (empty($pegawai)): ?>
            <div class="col-12">
                <div class="empty-state">
                    ...
                    <p class="empty-state-text mb-0">Belum ada data pegawai di divisi <strong><?= esc($divisi) ?></strong></p>
                </div>
            </div>
        <?php else: ?>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="pegawai-card">
                    ...
                    <h5 class="pegawai-name"><?= esc($p['nama_pegawai']) ?></h5>
